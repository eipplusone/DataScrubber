...
import pearson.Database.MySQL.MySQLDataType;
...
public class Database {
    ...
    private pearson.Database.DatabaseManager databaseManager;
    private DatabaseSettings databaseSettings;

    public static boolean isConnectionValid(String defaultSchema, String username, String password, String url) {

        try {
            pearson.Database.DatabaseManager databaseManager = new pearson.Database.DatabaseManager(username, password, url);
            return true;
    ...
    private void connect(String username, String password, String JDBCURL) throws SQLException {
        databaseManager = new pearson.Database.DatabaseManager(username, password, JDBCURL);
    }
