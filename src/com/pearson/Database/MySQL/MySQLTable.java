...
import pearson.Database.SQL.Column;
import pearson.Database.SQL.Table;
import pearson.Utilities.Query;
...
public class MySQLTable extends Table {
    ...
    pearson.Database.SQL.ConnectionConfig connectionConfig;
    DatabaseInterface databaseInterface;
    pearson.Database.DatabaseManager databaseManager;

    public MySQLTable(String tableName, pearson.Database.DatabaseManager databaseManager) {

        super(tableName);
        this.databaseManager = databaseManager;
        connectionConfig = new pearson.Database.SQL.ConnectionConfig(databaseInterface);
    }
     ...
     * @throws SQLException
     */
    public pearson.Database.SQL.ConnectionConfig getConnectionConfig() throws SQLException {
