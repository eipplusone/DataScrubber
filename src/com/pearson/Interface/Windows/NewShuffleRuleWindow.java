...
import pearson.Interface.Windows.Models.ItemsSelectedTableModel;
...
public class NewShuffleRuleWindow extends JDialog {
    ...
    public NewShuffleRuleWindow() throws SQLException {
        ...
        database = new Database(pearson.Interface.UIManager.getDefaultSchema(), pearson.Interface.UIManager.getUsername(),
                pearson.Interface.UIManager.getPassword(), "jdbc:mysql://" + pearson.Interface.UIManager.getUrl()
  ...
  //  }//GEN-LAST:event_errorTextAreaAncestorAdded
   ...
   // }//GEN-LAST:event_ignoreErrorsCheckboxActionPerformed
    ...
    private void createShuffleRuleButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_createShuffleRuleButtonActionPerformed
        ...
        Rule parentRule = pearson.Interface.UIManager.getParentRule();
        Rule newRule;
        ...
        pearson.Interface.UIManager.update();
